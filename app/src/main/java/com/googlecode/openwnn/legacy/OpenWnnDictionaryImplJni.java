...
public class OpenWnnDictionaryImplJni {
     ...
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#APPROX_PATTERN_EN_TOUPPER
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#setApproxPattern
     */
    public static final int APPROX_PATTERN_EN_TOUPPER               = WnnDictionary.APPROX_PATTERN_EN_TOUPPER;
    /**
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#APPROX_PATTERN_EN_TOLOWER
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR_UPPER
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#APPROX_PATTERN_JAJP_12KEY_NORMAL
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#SEARCH_EXACT
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#searchWord
     */
    public static final int SEARCH_EXACT                           = WnnDictionary.SEARCH_EXACT;
    /**
     * Constant about the search operation (for JNI native library)
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#SEARCH_PREFIX
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * Constant about the search operation (for JNI native library)
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#SEARCH_LINK
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#ORDER_BY_FREQUENCY
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * Constant about the sort order (for JNI native library)
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#ORDER_BY_KEY
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_V1
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    public static final int POS_TYPE_V1                             = WnnDictionary.POS_TYPE_V1;
    /**
     * Type of a part of speech (for JNI native library)
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_V2
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_V3
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_BUNTOU
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_TANKANJI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_SUUJI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_MEISI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_JINMEI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_CHIMEI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see com.googlecode.openwnn.legacy.WnnDictionary#POS_TYPE_KIGOU
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
     ...
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#clearDictionary
     * @param work      The internal work area
     * @return          0 if processing is successful; <0 if an error occur
     */
     ...
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#setDictionary
     * @param work      The internal work area
     ...
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#searchWord
     * @param work          The internal work area
     ...
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#getNextWord
     * @param work      The internal work area
     ...
     *
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#getNextWord
     * @param work      The internal work area
     ...
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#clearApproxPattern
     * @param work      The internal work area.
     */
     ...
     *
     * @see com.googlecode.openwnn.legacy.WnnDictionary#setApproxPattern
     * @param work      The internal work area
     ...
     * @param type          The type of a part of speech
     * @return              0 if type is not found; <0 if an error occur; >0 The part of speech
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_V1
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_V2
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_V3
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_BUNTOU
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_TANKANJI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_SUUJI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_MEISI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_JINMEI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_CHIMEI
     * @see com.googlecode.openwnn.legacy.OpenWnnDictionaryImplJni#POS_TYPE_KIGOU
     */
