...
/**
 * The preference class to clear learning dictionary for Chinese IME.
 * 
 * @author Copyright (C) 2009 OMRON SOFTWARE CO., LTD. All Rights Reserved.
 */
public class ClearLearnDictionaryDialogPreferenceZHCN extends DialogPreference {
	/** The context */
	 ...
	 */
	public ClearLearnDictionaryDialogPreferenceZHCN(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
	}
	 ...
	 *            The context
	 */
	public ClearLearnDictionaryDialogPreferenceZHCN(Context context) {
		this(context, null);
	}
	...
	protected void onDialogClosed(boolean positiveResult) {
		if (positiveResult) {
			...
			/* show the message */
			Toast.makeText(mContext.getApplicationContext(), R.string.dialog_clear_learning_dictionary_done, Toast.LENGTH_LONG).show();
		}
	}
